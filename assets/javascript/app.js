$(document).ready(function(){
    ...
    var movies = ["Real Housewives of Beverly Hills", "Real Housewives of New York", "Real Housewives of New Jersey", "Real Housewives of Orange County", "Real Housewives of Atlanta"]
    GIFArea = " "
    ...
    //==============DISPLAY INFO==============================
        $(document).on('click', 'button',  function() {
            ...
            // (this is necessary otherwise we will have repeat buttons)
                ...
                var queryURL = "https://api.giphy.com/v1/gifs/search?q=" + b + "&api_key=ndgx0YAub80qCCtqD2EBAPGYpHA7nvyg";  //query api url and public key
